    ...
    public class DelaiRepository : IDelaiRepository
    {
        ...
        {     
            ...
            else
            {
                ...
                if (estSousContrat)
                {
                    var idPartenaire = await (
                        from contratpartenaire in _dbContext.ContratPartenaire
                        join partnaire in _dbContext.Partenaire on contratpartenaire.idPartenaire equals partnaire.idPartenaire
                        where contratpartenaire.referenceContrat == clientIdentity.Ref_contrat
                        select partnaire.idPartenaire
                        ).FirstOrDefaultAsync();
